  ...
  return (
    <Card>
      ...
      <CardContent>
        <div 
          ref={mapContainer} 
          className="w-full h-48 sm:h-64 bg-muted rounded-lg flex items-center justify-center relative overflow-hidden"
          style={{
        ...
        >
          <div className="text-center space-y-2">
            <div className="text-sm sm:text-lg font-semibold text-muted-foreground">GPS Fleet Tracking</div>
            <div className="text-xs sm:text-sm text-muted-foreground px-4">
              Interactive map showing real-time vehicle locations
            </div>
            <div className="flex items-center justify-center space-x-2 sm:space-x-4 mt-4 flex-wrap">
            ...
            {Array.from({ length: 12 }, (_, i) => (
              <div
                ...
                className={`absolute w-2 h-2 rounded-full ${
                  i < 7 ? 'bg-success' : i < 10 ? 'bg-warning' : 'bg-destructive'
                }`}
                style={{
